 ...
 * with CAReward SDK
 */
- (void)sendConversionWithStartPage:(NSString*)url andCARewardPublicAppKey:(NSString*)CARewardPublicAppKey;
- (void)sendConversionWithStartPage:(NSString*)url buid:(NSString*)buid andCARewardPublicAppKey:(NSString*)CARewardPublicAppKey;
